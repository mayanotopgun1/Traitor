...
trait AddInterface {
    fn add_interface(&self, managed_ip: String, data: Json) -> (String, object);
}
...
trait AddInterfaces {
    fn add_interfaces(&self, managed_ip: String, device: HashMap<String, Json>) -> Vec<(String, object)>;
}
...
trait ProcessDevice {
    fn process_device(&self, managed_ip: String, device: HashMap<String, Json>) -> Vec<(String, object)>;
}
