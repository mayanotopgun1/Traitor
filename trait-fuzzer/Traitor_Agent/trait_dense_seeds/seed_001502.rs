...
pub fn main() {
    assert_eq!(E1::A(0, 0, 0).size(), 8);
    assert_eq!(E2::A(0, 0, 0).size(), 8);
    assert_eq!(E3::A(0, 0, 0).size(), 6);
    assert_eq!(E4::A(0, 0, 0).size(), 8);
    assert_eq!(E5::A(0, 0, 0).size(), align_size(10, align_of::<u32>()));
    assert_eq!(E6::A(0, 0, 0).size(), align_size(14, align_of::<u64>()));
    assert_eq!(E7::A(0, 0, 0).size(), align_size(6 + c_enum_min_size(), align_of::<c_int>()));
